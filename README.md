...
|:-----------|:--------------------------------|:------------:|:-----------:|--------------------------:|----------------------:|---------:|
| 1.         | Iris Flower Classification |   |  |[Iris Flower Classification]()|[Iris Flower Classification]()|-|
| 2.         | Car Price Prediction | 01-Feb-2021  | 07-Feb-2021 |[Car Price Prediction](https://github.com/vaibhavhariaramani/Car-price-prediction)|[Car Price Prediction](https://medium.com/geeky-bawa)|[Click](https://car-price-predictor-using-ml.herokuapp.com/)|
| 3.         | Diabetes Prediction | under Construction  | under Construction |[Diabetes Prediction]()|-|[Click]()|
| 4.         | Flight Price Prediction | under Construction  | under Construction |[Flight Price Prediction]()|-|[Click]()|
| 5.         | Heart Diseases Prediction | under Construction  | under Construction |[Heart Diseases Prediction]()|-|[Click]()|
| 6.         | House Price Prediction | 7-Sep-2020  | 11-Sep-2020 |[House Price Prediction](https://github.com/vaibhavhariaramani/House-Price-Prediction-with-frontend-Application)|[ House Price Prediction](https://medium.com/geeky-bawa)|[Click](https://indian-house-price-prediction.herokuapp.com/)|
| 7.         | IPL Score Prediction | under Construction  | under Construction |[IPL Score Prediction]()|-|[Click]()|
| 8.         | Mobile Price Prediction | under Construction  | under Construction |[Mobile Price Prediction]()|[Mobile Price Prediction](https://medium.com/geeky-bawa)|-|
| 9.         | Loan Prediction | under Construction  | under Construction |[Loan Prediction]()|[Loan Prediction](https://medium.com/geeky-bawa)|-|
| 10.         | Beer Consumptio Prediction | under Construction  | under Construction |[Beer Consumptio Prediction]()|-|-|
| 11.         | Employee Salary Prediction | under Construction  |under Construction |[Employee Salary Prediction](https://github.com/vaibhavhariaramani/)|-|[Click]()|
...
> **Step 2** :
   ...
   [![Alt Text](Images/git.PNG)](https://github.com/vaibhavhariaramani/Machine-Learning-Projects-and-Tutorials)
   ...
   - Clone my repository to your local machine by running the following command. Before doing this, you have to install git on your machine and make sure you are having proper internet connection.
      ...
      ```bash
      git clone https://github.com/vaibhavhariaramani/Machine-Learning-Projects-and-Tutorials.git
      ```
   ...
   - If you don't want to mess up with all these things, you can just download the *zip* file of my GitHub repository by clicking [here](https://github.com/vaibhavhariaramani/Machine-Learning-Projects-and-Tutorials/archive/refs/heads/master.zip) and extract it to any file location as your wish and then use it.
